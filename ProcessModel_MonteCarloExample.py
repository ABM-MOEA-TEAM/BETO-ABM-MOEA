...
# Inject probability distributions on dataframe rows, return randomly distributed
# versions of selected variables
# See https://numpy.org/doc/1.16/reference/routines.random.html for list of distributions
# Simple MC example https://github.com/chris1610/pbpython/blob/master/notebooks/Monte_Carlo_Simulationv2.ipynb
# https://pbpython.com/monte-carlo.html
altered_IO = UF.randomizeIO(biomass_IO, D.distribution_list)
