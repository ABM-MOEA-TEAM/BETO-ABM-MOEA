...
LCA_WDP = 'WDP'
LCA_Acidification = 'Acidification'
LCA_Ecotoxicity = 'Ecotoxicity'
LCA_Eutrophication = 'Eutrophication'
LCA_HHC = 'HHC'
LCA_HHNC = 'HHNC'
LCA_Ozone_Depletion = 'Ozone_Depletion'
LCA_Ozone_Formation = 'Ozone_Formation'
LCA_Resource_Depletion = 'Resource_Depletion'
LCA_Respiratory_Effects = 'Respiratory_Effects'
